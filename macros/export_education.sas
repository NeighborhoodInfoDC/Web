...
%if &ds. = acs or &ds. = prevacs %then %do;
    ...
    %Moe_prop_a( var=Pct25andOverWoutHS_m_&ncdbyr., mult=100, num=Pop25andOverWoutHS_&ncdbyr., den=Pop25andOverYears_&ncdbyr., 
                       num_moe=mPop25andOverWoutHS_&ncdbyr., den_moe=mPop25andOverYears_&ncdbyr. );


	keep Pct25andOverWoutHS_m_&ncdbyr.;

	rename 	Pct25andOverWoutHS_m_&ncdbyr. = Pct25andOverWoutHS_m
			;
...
data alldata_&topic.&geosuf.;
	set Ncdb_acs_&topic.&geosuf. (in=a) 
		...
		msf_sum&geosuf._long_allyr (in=e) ;
